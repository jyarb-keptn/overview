...
pipeline {
    ...
    parameters {
         ...
         string(defaultValue: 'keptnexamples/carts', description: 'Carts Service Image', name: 'cartsImage', trim: false)
	 choice(name: 'Release', choices: ["0.12.1", "0.12.2", "0.12.3"], description: 'Carts Service with Tag [:0.12.1,:0.12.2,:0.12.3]')
         ...
         string(defaultValue: 'mongo:4.2.2', description: 'Carts-db Service with Tag [:4.2.2]', name: 'cartsdbImage', trim: false)
