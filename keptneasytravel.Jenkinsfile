...
pipeline {
    ...
    parameters {
         ...
         string(defaultValue: 'docker.io/dynatrace/easytravel-mongodb:2.0.0.3349', description: 'Mongo DB Image', name: 'Image1', trim: false)
         string(defaultValue: 'easytravel-backend', description: 'easytravel Backend', name: 'Service2', trim: false)
         string(defaultValue: 'docker.io/dynatrace/easytravel-backend:2.0.0.3349', description: 'easytravel Backend', name: 'Image2', trim: false)
         string(defaultValue: 'easytravel-frontend', description: 'easytracel Frontend', name: 'Service3', trim: false)
         string(defaultValue: 'docker.io/dynatrace/easytravel-frontend:2.0.0.3349', description: 'easytravel Frontend', name: 'Image3', trim: false)
         string(defaultValue: 'easytravel-www', description: 'easytravel nginx service', name: 'Service4', trim: false)
         string(defaultValue: 'docker.io/dynatrace/easytravel-nginx:2.0.0.3349', description: 'easytravel nginx', name: 'Image4', trim: false)
         string(defaultValue: 'easytravel-angular', description: 'easytravel nginx service', name: 'Service5', trim: false)
         string(defaultValue: 'docker.io/dynatrace/easytravel-angular-frontend:2.0.0.3349', description: 'easytravel amgular', name: 'Image5', trim: false)
