...
pipeline {
    ...
    parameters {
         ...
         string(defaultValue: 'dynatrace/easytravel-mongodb:2.0.0.3356', description: 'Mongo DB Image', name: 'Image1', trim: false)
         string(defaultValue: 'easytravel-backend', description: 'easytravel Backend', name: 'Service2', trim: false)
         string(defaultValue: 'dynatrace/easytravel-backend:2.0.0.3356', description: 'easytravel Backend', name: 'Image2', trim: false)
         string(defaultValue: 'easytravel-frontend', description: 'easytracel Frontend', name: 'Service3', trim: false)
         string(defaultValue: 'dynatrace/easytravel-frontend:2.0.0.3356', description: 'easytravel Frontend', name: 'Image3', trim: false)
